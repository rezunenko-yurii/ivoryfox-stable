...
namespace CloudContentDeliveryManagment.Model
{
    ...
    public partial class ReleaseUpdate :  IEquatable<ReleaseUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseUpdate" /> class.
        /// </summary>
        /// <param name="notes">notes.</param>
        public ReleaseUpdate(string notes = default(string))
        {
            this.Notes = notes;
        }
        ...
        {
            return this.Equals(input as ReleaseUpdate);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseUpdate input)
        {
            if (input == null)
                return false;
