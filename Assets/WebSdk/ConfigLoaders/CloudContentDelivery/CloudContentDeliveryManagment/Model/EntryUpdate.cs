...
namespace CloudContentDeliveryManagment.Model
{
    ...
    public partial class EntryUpdate :  IEquatable<EntryUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntryUpdate" /> class.
        /// </summary>
        ...
        public EntryUpdate(string contentHash = default(string), int? contentSize = default(int?), string contentType = default(string), List<string> labels = default(List<string>), Object metadata = default(Object))
        {
        ...
        {
            return this.Equals(input as EntryUpdate);
        }

        /// <summary>
        /// Returns true if EntryUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of EntryUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntryUpdate input)
        {
            if (input == null)
                return false;
