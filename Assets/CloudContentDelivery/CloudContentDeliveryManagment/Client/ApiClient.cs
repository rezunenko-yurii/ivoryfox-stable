...
namespace CloudContentDeliveryManagment.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = CloudContentDeliveryManagment.Client.Configuration.Default;
            RestClient = new RestClient("https://content-api.cloud.unity3d.com/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://content-api.cloud.unity3d.com/api/v1).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? CloudContentDeliveryManagment.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://content-api.cloud.unity3d.com/api/v1")
        {
