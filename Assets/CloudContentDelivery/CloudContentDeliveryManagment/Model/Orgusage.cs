...
namespace CloudContentDeliveryManagment.Model
{
    ...
    public partial class Orgusage :  IEquatable<Orgusage>, IValidatableObject
    {
        /// <summary>
        ...
        public Orgusage(string id = default(string), DateTime? startTime = default(DateTime?), List<Usage> usage = default(List<Usage>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as Orgusage);
        }

        /// <summary>
        /// Returns true if Orgusage instances are equal
        /// </summary>
        /// <param name="input">Instance of Orgusage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Orgusage input)
        {
            if (input == null)
                return false;
