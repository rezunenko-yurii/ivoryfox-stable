...
namespace CloudContentDeliveryManagment.Model
{
    ...
    public partial class Userapikey :  IEquatable<Userapikey>, IValidatableObject
    {
        /// <summary>
        ...
        public Userapikey(string apikey = default(string))
        {
            // to ensure "apikey" is required (not null)
            if (apikey == null)
            {
                throw new InvalidDataException("apikey is a required property for Userapikey and cannot be null");
            }
            else
            {
                this.Apikey = apikey;
        ...
        {
            return this.Equals(input as Userapikey);
        }

        /// <summary>
        /// Returns true if Userapikey instances are equal
        /// </summary>
        /// <param name="input">Instance of Userapikey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Userapikey input)
        {
            if (input == null)
                return false;
