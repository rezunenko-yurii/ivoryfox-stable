...
namespace CloudContentDeliveryManagment.Model
{
    ...
    public partial class Releaseentry :  IEquatable<Releaseentry>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeState
        /// </summary>
        ...
        {
            return this.Equals(input as Releaseentry);
        }

        /// <summary>
        /// Returns true if Releaseentry instances are equal
        /// </summary>
        /// <param name="input">Instance of Releaseentry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Releaseentry input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ChangeState == input.ChangeState ||
                    (this.ChangeState != null &&
                    this.ChangeState.Equals(input.ChangeState))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChangeState != null)
                    hashCode = hashCode * 59 + this.ChangeState.GetHashCode();
