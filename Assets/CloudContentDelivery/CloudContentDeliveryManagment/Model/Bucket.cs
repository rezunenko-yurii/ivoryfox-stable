...
namespace CloudContentDeliveryManagment.Model
{
    ...
    public partial class Bucket :  IEquatable<Bucket>, IValidatableObject
    {
        ...
        public Bucket(Changecount changes = default(Changecount), DateTime? created = default(DateTime?), string description = default(string), Guid? id = default(Guid?), Release lastRelease = default(Release), string name = default(string), Guid? projectguid = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastRelease: ").Append(LastRelease).Append("\n");
        ...
        public bool Equals(Bucket input)
        {
            ...
            return 
                ...
                (
                    this.LastRelease == input.LastRelease ||
                    (this.LastRelease != null &&
                    this.LastRelease.Equals(input.LastRelease))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastRelease != null)
                    hashCode = hashCode * 59 + this.LastRelease.GetHashCode();
                if (this.Name != null)
